...
Before you report an issue, or wish to add cool functionality please try and check to see if there are existing [issues](https://github.com/jfdm/idris-containers/issues) and [pull requests](https://github.com/jfdm/idris-containers/pulls).
...
1. Fork the [main development repository](https://github.com/jfdm/idris-containers) on github e.g.
...
3. Add `jfdm/idris-containers` as a remote upstream
...
1. Go to GitHub and submit a pull request to `idris-containers`
